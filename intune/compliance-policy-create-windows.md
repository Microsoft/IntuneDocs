...
**Note:** The policy Require Secure Boot to be enabled on the device is supported on both TPM 1.2 and 2.0 devices, but the status of the policy in the Intune console will always show as "Not Compliant" for devices that do not support TPM 2.0 or later. This is a limitation of the “Device Health Attestation” service in Windows 10. For more information see, [Device health attestation] (https://docs.microsoft.com/en-us/windows/security/information-protection/tpm/trusted-platform-module-overview#device-health-attestation).
